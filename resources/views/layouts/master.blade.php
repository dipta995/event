...
{{--		</nav>--}}
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="{{ url('/') }}"><img style="height: 60px;" src="{{ asset('user/images/logo.png') }}" alt=""></a>
		</div>
		...
		<div class="top-area">
			...
			<ul class="setting-area">
					<li>
                    @livewire('notificationcountcomponent')
			...
			<div class="user-img">
				<img src="{{ asset('user/images/resources/admin.jpg') }}" alt="{{ Auth::user()->name }}">
				<span class="status f-online"></span>
				<div class="user-setting">

{{--					<a href="{{ route('profile.show') }}" title=""><i class="ti-user"></i> view profile</a>--}}
									...
									<div class="widget">
										...
										<ul class="naves">
                                            ...
                                            <li>
												...
												<a href="{{ url('packages/order/history') }}" title="">Package History</a>
											</li>
...
{{--											</li>--}}
                                            ...
                                            <i class="ti-power-off"></i>
                                                <button style="background: #fff;border:2px solid #fff; color:#03658c;" type="submit" name="Logout" id="">Logout</button>
                                        </form>
							...
							<div class="col-lg-3">
								<aside class="sidebar static">
                                    ...
                                    @livewire('page-like-component')


                                    @endif
                                    @if (auth()->user()->channel=='no')


									<div class="widget">
										<div class="banner medium-opacity bluesh">
											<div class="bg-image" style="background-image: url({{ asset('user/images/resources/baner-widgetbg.jpg') }})"></div>
											<div class="baner-top">
												<span><img alt="" src="{{ asset('user/images/book-icon.png') }}"></span>
											...
											<div class="banermeta">
												...
												<a data-ripple="" title="" href="{{ url('/channel/create') }}">start now!</a>
											</div>
										</div>
									</div>
                                    @endif
...
{{--						<div class="foot-logo">--}}
{{--							<div class="logo">--}}
{{--								<a href="index-2.html" title=""><img src="{{ asset('user/images/logo.png') }}" alt=""></a>--}}
{{--							</div>--}}
{{--							<p>--}}
...
{{--	</footer><!-- footer -->--}}
	<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="copyright"><a target="_blank" href="">Event</a></span>
					<i><img src="{{ asset('user/images/credit-cards.png') }}" alt=""></i>
				</div>
			</div>
		</div>
	</div>
...
<script src="{{ asset('user/js/60919cd4c3.js') }}"></script>

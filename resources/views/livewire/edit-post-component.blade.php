<div>
    <form>
        ...
        <div class="form-group">
            ...
            <textarea style="border: 1px solid black; background: white;" wire:model="post_text" id="" cols="2" rows="5" class="form-control"></textarea>
            <div style="border: 1px solid black; margin-top: 5px;" class="attachments">
                <ul>
                    <li>
                    ...
                    @else
                        <li>
                            ...
                            <a class="btn btn-info" href="{{ url('channel/payment',Auth::user()->id) }}">Pay 1000
                                Taka</a>
                        </li>
                    @endif
                </ul>
                    ...
                    @foreach ($images as $key=>$image)
                        <div class="col-md-2">
                            <div class="card" style="width: 120px;">
                                <div class="card-body">
                                    <img style="float: left;height: 60px;width: 60px;" class="card-img-top"
                                         src="{{ $image->temporaryUrl() }}" alt="Uploading...">

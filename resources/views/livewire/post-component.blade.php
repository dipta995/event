                            ...
                            <ul id="comments-list" class="comments-list">
                                ...
                                <li>
                                    <div class="comment-main-level">
                                        <!-- Avatar -->
                                        <div class="comment-avatar"><img src="{{ $comments->user->profile_photo_path}}" alt=""></div>
                                    ...
                                    @endphp
                                        ...
                                        <li>
                                            ...
                                            <div class="comment-box">
                                                <div class="comment-head">
                                                    <h6 class="comment-name"><a href="#">{{ $replays->name }}</a></h6>
                                                    <span>{{ $replays->created_at }}</span>
                                                    @if ( auth()->user()->name == $replays->name )

                                                <a wire:click.prevent="replaytdelete({{ $replays->id }})" href="#"><i class="fa fa-trash" aria-hidden="true"></i>{{ $replays->id }}</a>
                                                @endif
